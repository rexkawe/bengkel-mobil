    ...
    try {
      ...
      if (response.success) {
        ...
        if (expectedRole && user.role !== expectedRole) {
          console.warn(`🛑 Login blocked: Role mismatch. Expected ${expectedRole}, got ${user.role}`);
          return {
            success: false,
            message: expectedRole === 'admin'
              ? 'Akses ditolak. Silakan login menggunakan akun Admin.'
              : 'Akses ditolak. Admin harap login melalui Admin Panel.'
          };
        }
