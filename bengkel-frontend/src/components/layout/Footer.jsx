      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h2 className="text-xl font-bold">Adit AutoCare</h2>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-primary-100">(021) 1234-5678</span>
              </div>
              <div className="flex items-center space-x-2">
                <EnvelopeIcon className="h-5 w-5 text-accent-400" />
                <span className="text-primary-100">info@aditautocare.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-primary-500 mt-8 pt-8 text-center">
          <p className="text-primary-200">
            © 2024 Adit AutoCare Bengkel Modern. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
